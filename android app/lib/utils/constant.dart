//With PHP backend
const BASE_URL = "https://worldengineeringcorporation.com/gbu/";

//without PHP backend
const PURCHASE_CODE = '';
const BASE_URL_OFFLINE = 'https://worldengineeringcorporation.com/gbu/view/getjson.php?user=$PURCHASE_CODE';
...
const adMobInterstitialId = "ADD YOUR ADMOB INTERSTITIAL ID";
const adMobBannerIdIos = "ADD YOUR BANNER ID IOS";
const adMobInterstitialIdIos = "ADD YOUR ADMOB INTERSTITIAL ID";

// Facebook
const FACEBOOK_KEY = 'ADD YOUR FACEBOOK KEY';
const fbBannerId = "ADD YOUR FACEBOOK BANNER ID";
const fbBannerIdIos = "ADD YOUR FACEBOOK BANNER ID IOD";
