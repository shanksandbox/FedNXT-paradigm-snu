...
class ReturnPurchaseController extends Controller
{
    public function index(Request $request)
    {
        ...
        if($role->hasPermissionTo('returns-index')) {
            ...
            return view('return_purchase.index',compact('starting_date', 'ending_date', 'warehouse_id', 'all_permission', 'lims_warehouse_list'));
        }
        else
    ...
    public function create(Request $request)
    {
        ...
        if($role->hasPermissionTo('purchase-return-add')) {
            ...
            return view('return_purchase.create', compact('lims_warehouse_list', 'lims_tax_list', 'lims_account_list', 'lims_purchase_data', 'lims_product_purchase_data'));
        }
        else
            return redirect()->back()->with('not_permitted', 'Sorry! You are not allowed to access this module');
    }
