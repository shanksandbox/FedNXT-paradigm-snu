...
class DiscountPlanController extends Controller
{
    public function index()
    {
        ...
        if($role->hasPermissionTo('discount_plan')) {
            ...
            return view('discount_plan.index', compact('lims_discount_plan_all'));
        }
        else
    ...
    public function create()
    {
        ...
        return view('discount_plan.create', compact('lims_customer_list'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('discount_plan.edit', compact('lims_discount_plan', 'lims_customer_list', 'customer_ids'));
    }
