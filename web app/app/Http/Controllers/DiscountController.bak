...
class DiscountController extends Controller
{
    public function index()
    {
        ...
        if($role->hasPermissionTo('discount_plan')) {
            ...
            return view('discount.index', compact('lims_discount_all'));
        }
        else
    ...
    public function create()
    {
        ...
        return view('discount.create', compact('lims_discount_plan_list'));
    }
    ...
    public function edit($id)
    {
        ...
        $lims_discount_plan_list = DiscountPlan::where('is_active', true)->get();
        return view('discount.edit', compact('lims_discount_data', 'discount_plan_ids', 'lims_discount_plan_list'));
    }
